...
import {
  ...
  Plus, ArrowRight, CheckCircle2, Clock, Download, LayoutDashboard
} from "lucide-react";
...
export default function Dashboard() {
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <div className="flex items-center gap-2">
            {[
              ...
              //item de abajo, cambiar a step si falla
  ...
  function MenuDefault2() {
    return (
      <>
        {/* Sección de Accesos Rápidos (En lugar de los Stats con 0) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Tarjeta 1: Nueva Acta */}
          <div
            onClick={() => navigate("/nuevo-expediente")}
            className="group p-5 rounded-xl border border-border bg-card hover:border-primary/50 hover:shadow-md transition-all cursor-pointer relative overflow-hidden"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">Nueva Acta</h3>
                <p className="text-xs text-muted-foreground">Crear nuevo expediente de cliente</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">Gestionar Catálogos</h3>
                <p className="text-xs text-muted-foreground">Configurar monedas, países y áreas</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">Ver Historial</h3>
                <p className="text-xs text-muted-foreground">Revisar registros y estados de EPs</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div>
        <p className="text-md text-muted-foreground mt-0.5">
          Bienvenido, <span className="text-foreground font-medium">{currentUser?.displayName ?? currentUser?.username}</span>
        </p>
      </div>
      <MenuDefault2 />
