-- Migración ajuste-12: Eliminar columnas legacy y dejar schema limpio
...
-- ============================================================
-- 3. evaluaciones: remover actaId, expedienteUuid
-- ============================================================
...
SELECT 'Migración completada exitosamente';
